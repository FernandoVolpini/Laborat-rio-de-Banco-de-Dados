insert into tb_clientes (id_cliente, nome, sobrenome, dt_nascimento, telefone, fgativo)

VALUES(4, 'Gail', 'Black', '800-555-1214', 1);

INSERT INTO tb_clientes(id_cliente, nome, sorenome, dt_nascimento, telefone, fg_ativo)
...
VALUES(3, 2, 'Supernova', 'A star explodes', 26.99,1);
